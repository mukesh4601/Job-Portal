...
error_reporting(0);
	...
	$tableName="seekersavedjobs";		
	$targetpage = "seeker-profile.php"; 	
	$limit = 1; 
	
	
	$query = "SELECT COUNT(*) as num  FROM $tableName INNER JOIN postjob
...
INNER JOIN postjob
ON seekersavedjobs.jobid=postjob.jobid  where seekerid=$seekerid  LIMIT $start, $limit";
